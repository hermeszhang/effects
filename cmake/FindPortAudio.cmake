...
find_library(PORTAUDIO_LIBRARIES
  NAMES portaudio
  PATHS HINTS ${PC_PORTAUDIO_LIBDIR})
...
if (EXISTS ${PORTAUDIO_INCLUDE_DIRS}/portaudio.h)
  ...
  CHECK_CXX_SOURCE_COMPILES( "#include <portaudio.h>\nPaDeviceIndex pa_find_device_by_name(const char *name); int main () {return 0;}" PORTAUDIO2_FOUND)
...
endif (EXISTS ${PORTAUDIO_INCLUDE_DIRS}/portaudio.h)
